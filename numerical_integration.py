...
def z2(p2, z1):
    ...
    x_0 = np.sum([p2 * integrate.quad(I_x0y0, 0, 1, args=(z1))[0], (1-p2) * integrate.quad(I_x0y1, 0, 1, args=(z1))[0]]) #[y=0, y=1]
    x_1 = np.sum([(1 - p2) * integrate.quad(I_x1y0, 0, 1, args=(z1))[0], p2 * integrate.quad(I_x1y1, 0,1, args=(z1))[0]])   #[y=0, y=1]
    print(x_0, x_1)
    return (x_0 < x_1)
